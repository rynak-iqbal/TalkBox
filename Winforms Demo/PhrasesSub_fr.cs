...
{
    public partial class PhrasesSub_fr : UserControl
    {
        String category;
        private Phrases_fr phrasesPage = MainPage.phrases1_fr;
        private List<Button> phrasesButtons = new List<Button>();
        public PhrasesSub_fr(string category)
        {
            this.category = category;
            InitializeComponent();
            loadSub(category);
            this.Load += PhrasesSub_frMenu_Load;
        }
        ...
        private void PhrasesSub_frMenu_Load(object sender, EventArgs e)
        {
